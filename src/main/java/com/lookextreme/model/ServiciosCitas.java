...
@NamedQueries({
    ...
    @NamedQuery(name = "ServiciosCitas.findEstilista", query = "SELECT s FROM ServiciosCitas s WHERE s.citaidCita.estilistausuarioidUsuario.usuario.idUsuario = :idUsuario")})
